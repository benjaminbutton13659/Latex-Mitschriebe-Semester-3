...
\begin{tikzpicture}
	...
	\draw[->,thick] (-1.1,-1) -- (-1.1,1) node[above] {$\vec{E}_\textrm{ext}$};
...
\begin{enumerate}[i)]
	...
	&\underline{n = 1:} \quad \left(a_1 r + \frac{b_1}{r^2}\right)\cancel{\frac{2}{3}} \buildrel r \to \infty \over \longrightarrow - \cancel{\frac{2}{3}} E_0 r \quad \Rightarrow \ \, \ \quad \quad \ \  a_1 = E_0\\
	&\underline{n > 1:} \quad \left(a_n r^n + \frac{b_n}{r^{n+1}}\right) \frac{2}{2n+1} \buildrel r \to \infty \over \longrightarrow \quad \Rightarrow \quad \ a_n = 0
	\end{align*}
...
\hfill%
\begin{tikzpicture}
	\draw[shade, ball color=gray!50!white] (0,0) circle (1cm);
