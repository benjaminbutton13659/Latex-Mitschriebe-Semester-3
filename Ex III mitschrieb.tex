...
\begin{minipage}{\linewidth}
	...
	\draw[thick] (A) -- (c) -- (B);
	\draw (-1.5,0) -- (1.5,0);
	\filldraw[draw=none,pattern=north east lines] (-1.25,0) rectangle (1.25,-.8);
	\node at (-2,.5) {$ c_1 n_1 $};
	\node at (-2,-.5) {$ c_2 n_2 $};
	\draw[dashed] (0,-1) -- (0,1);
...
% T6:
\begin{tikzpicture}
	%\tikz\draw (0,0) -- (-60:1cm) -- (45:1cm);
	%\draw (0,0) -- (-120:1cm);
	%\draw    (0cm,0cm) -- (30:1cm) -- (60:1cm) -- (90:1cm) -- (120:1cm) -- (150:1cm) -- (180:1cm);
	\draw (0,1) -- (210:1cm) -- (330:1cm) -- (90:1cm);
	\draw (2,2) -- ++(120:1cm) -- ++(240:1cm) -- ++(360:1cm);
\end{tikzpicture}
