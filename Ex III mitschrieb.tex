...
\begin{enumerate}[(1)]
	...
	\begin{equation*}
	\sin \varphi \apprge \frac{D}{2 \varphi_1}
	\end{equation*}
\end{enumerate}
\begin{center}
	\begin{minipage}{.5\linewidth}
...
\cos \left(\omega t - k z + \varphi\right) \\ \cos \left(\omega t -  z + \varphi + \frac{\pi}{2}\right) \\
0
\end{pmatrix}
\end{align*}
...
\cos\left(\omega t - kz .....\right)
\end{pmatrix} .....
\end{align*}
\begin{equation*}
k^+ = \overline{k} + \delta l \qquad k^- = \overline{k} - \delta k
\end{equation*}
...
\end{equation*}
\begin{equation*}
\tx{rot} \vec{E} = - \prt{}{t} \vec{B} \qquad \tx{rot} \vec{H} = \vec{j} + \prt{}{t} \vec{D}
\end{equation*}
plus:
\begin{align*}
