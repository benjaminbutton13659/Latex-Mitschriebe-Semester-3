...
\begin{itemize}
	...
	\item \versuch{Interferenz an Planparalleser Folie} (mit grünem Laserlicht demonstriert)
\end{itemize}

\subsection{Vielstrahlinterferenz, Fabry-P\'erot-Interferometer}
...
Fabry Airy ??? Formeln % sowas gibt es nicht???
Hier fehlt eine Gleichung: % warum???
...
\begin{center}
	\begin{minipage}{.5\linewidth}
		\rbox{
			...
			\end{equation*}
			\begin{equation*}
			I_T = I_0 XXX\frac{XXX}{1 + F \sin^2 \left(\frac{\Delta \varphi}{2}\right)}
			\end{equation*}
		}
	\end{minipage}
\end{center}
