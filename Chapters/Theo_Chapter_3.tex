...
\begin{enumerate}[I)]
	...
	\begin{tikzpicture}
		...
		\draw[black!20!red,thick] ($ (2) + (135+30:.15) $) -- ++(-45+30:.3);
		\node[black!20!red,anchor=north west] at (2) {$ \vec{E}_2 $};
		...
		\draw[black!20!red,thick] ($ (e) + (135+45:.15) $) -- ++(-45+45:.3);
		\node[black!20!red,anchor=north west] at (e) {$ \vec{E}_e $};
		...
		\draw[black!20!red,thick] ($ (r) + (135+45:.15) $) -- ++(-45+45:.3);
		\node[black!20!red,anchor=north east] at (r) {$ \vec{E}_r $};
...
\begin{enumerate}[i)]
	...
	%
\end{enumerate}
Nun noch eine Erklärung die etwas umständlicher ist:\\
%
%
%
%t6:
