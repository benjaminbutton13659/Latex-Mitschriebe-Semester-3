...
\begin{enumerate}[i)]
	\item
	\begin{equation*}
	U_{\tx{max}} = \const \cdot f - U_0 \qquad U_0 = \frac{W_A}{e}
	\end{equation*}
...
Material mit Licht bestrahlen $ \Rightarrow $ austretende Photoelektronen genau analysieren.\\
...
$ \Rightarrow $ Elementanalyse\\[25pt]
\textbf{Photomultiplikator}\\
\folie{Photomultiplikator}\\[5pt]
...
Das selbe geht auch mit Neutronen oder großen Molekülen (z.B. $ \tx{C}_{60} $)\\
...
\begin{center}
	\begin{tabular}{l|l|l}
		...
		\hline
		& & \\[-5pt]
		Energiedichte & $ w = \displaystyle\frac{1}{2} \epsilon_0 \left(E^2 + c^2 B^2\right) $ & $ w = \rho \hbar \omega $\\[7pt]
		\hline
		& & \\[-5pt]
...
\begin{equation*}
\Delta N \cdot \Delta f \ge \sim \vec{\Pi}
\end{equation*}